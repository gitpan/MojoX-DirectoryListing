...

{
	...
	mk_file "$_/old.txt" for @madedirs;
	mk_file "$_/forbidden.gif" for @madedirs;
	chmod 000, "$_/forbidden.gif" for @madedirs;
	sleep 2;
	mk_file "$_/middle.html" for @madedirs;
	sleep 2;
	mk_file "$_/young.vb" for @madedirs;
    }
